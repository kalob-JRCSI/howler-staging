...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BaX5RJVJ.mjs");
...
var manifest = {
	"18c2debec09a0eeb1f0f77016c8045dcef4d6b133c01bf938859b96b39e0e1c5": {
		functionName: "readDrawingShare_createServerFn_handler",
		importer: () => import("./drawing-share-fns-BsIfOzTO.mjs")
	},
	"75b0ea8bf3b02498fdd870a23dd5f5b323258a1fb0921feb6f7eb91519334be4": {
		functionName: "pushDrawingSnapshot_createServerFn_handler",
		importer: () => import("./drawing-share-fns-BsIfOzTO.mjs")
	},
	"c3573c7a8599decedb60554e43d745a99df6ec60293f0c04fe3388cdf29e9c36": {
		functionName: "endDrawingShare_createServerFn_handler",
		importer: () => import("./drawing-share-fns-BsIfOzTO.mjs")
	},
	"e75d8acc15007fa50c1f3f3fefa2ff99b79809667c30053018d05b1f4531d616": {
		functionName: "upsertDrawingShare_createServerFn_handler",
		importer: () => import("./drawing-share-fns-BsIfOzTO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BiflSdL7.mjs").then((n) => n.t),
