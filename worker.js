// HOWLER Scheduling Intelligence staging bundle v0.9.1
...
function computeConfidence(model, activity, generatedAt) {
    ...
    const fieldVerification = activity.actualFinish ? 1 : activity.actualStart ? 0.95 : average(sources.filter((s) => ["FIELD_REPORT", "ACTUAL_VERIFICATION"].includes(s.type)).map(sourceScore), 0.4);
...
<main>
  ...
  <section class="card">
    <div class="buttons">
      ...
      <button id="forecast" class="secondary">View v0.9.1 Forecast</button>
      <button id="forecastHealth" class="secondary">v0.9.1 Forecast Health</button>
      <button id="events" class="secondary">View v0.9.1 Evidence Events</button>
